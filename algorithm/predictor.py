...
class VisualizationDemo(object):
    def __init__(self, cfg, instance_mode=ColorMode.SEGMENTATION, parallel=False):
        ...
        """修改处"""
        self.metadata.thing_classes = ["0", "1", "2", "3", "4", "5", "6"]
        self.metadata.thing_colors = [[0, 128, 0], [0, 0, 255], [128, 0, 128], [255, 255, 0], [255, 0, 0],
                                      [255, 165, 0], [0, 0, 0]]
        """修改处-end"""
        self.cfg = cfg
    ...
    def run_on_image(self, image):
        ...
        if "panoptic_seg" in predictions:
            ...
            if "instances" in predictions:
                ...
                vis_output, data_json = visualizer.draw_instance_predictions(predictions=instances)

        return predictions, vis_output, data_json
